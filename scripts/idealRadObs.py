...
if case_type == 'idealized':     #--- Must Explicitly List All Parameters
   xloc = [100000]               #--- The Location of the Radar (either Longitude [WRF] or Distance [CM1]
   yloc = [100000]               #--- The Location of the Radar (either Latitude  [WRF] or Distance [CM1]
   hgt  = [0.0]                  #--- The height of the radar station of sea level (JDL Working on This)
   ...
   nrdr = len(xloc)
   output_path = '../output/single_rdr' #--- Output Radar Observation Object into a Pickle File
