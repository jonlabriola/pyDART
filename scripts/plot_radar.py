...
parser.add_argument("--name",type=str,default='',help='The location of the dmax file')
...
outname = 'radar_%s_%s_%03d_%03dtilt.png'%(arguments.name,arguments.var,arguments.platform,arguments.tilt)

pydart.plotting.twod_plot(plotvar,arguments.var,tilt=arguments.tilt,outname=outname)
